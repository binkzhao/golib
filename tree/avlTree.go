...
func (avlNode *AVLNode) Put(value interface{}) *AVLNode {
	if avlNode == nil {
	...
	case -1:
		...
		avlNode.Left = avlNode.Left.Put(value)
		avlNode = avlNode.adjust() // 自动调整平衡
	case 1:
		avlNode.Right = avlNode.Right.Put(value)
...
// 删除数据
func (avlNode *AVLNode) Remove(value interface{}) *AVLNode {
	// 没有找到匹配的数据
	if avlNode == nil {
	...
	case 0:
		...
		if avlNode.Left != nil && avlNode.Right != nil { // 结点有左孩子和右孩子
			...
			avlNode.Right = avlNode.Right.Remove(avlNode.Data)
